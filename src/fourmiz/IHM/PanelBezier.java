...
public class PanelBezier extends javax.swing.JFrame {
     ...
     */
    public PanelBezier(CurveCanvas curveCanvas) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PanelBezier.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PanelBezier(curveCanvas).setVisible(true);
