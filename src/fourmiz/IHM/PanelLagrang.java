 ...
 * @author crysy
 */
public class PanelLagrang extends javax.swing.JFrame {

    private ArrayList<Point>pts = new ArrayList<>();
    private static CurveCanvas curveCanvas;
    /** Creates new form PanelLagrang */
    public PanelLagrang(CurveCanvas curveCanvas) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PanelLagrang.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PanelLagrang(curveCanvas).setVisible(true);
            }
        });
    }
